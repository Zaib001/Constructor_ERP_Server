...
router.post("/", authenticateJWT, requirePermission("company.manage"), controller.createCompany);

// Update company
router.patch("/:id", authenticateJWT, requirePermission("company.manage"), controller.updateCompany);

// Deactivate company
router.delete("/:id", authenticateJWT, requirePermission("company.manage"), controller.deleteCompany);
